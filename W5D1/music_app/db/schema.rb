...
ActiveRecord::Schema.define(version: 2018_05_10_212557) do
  ...
  create_table "albums", force: :cascade do |t|
    ...
    t.index ["band_id", "title", "year", "is_live"], name: "index_albums_on_band_id_and_title_and_year_and_is_live", unique: true
  ...
  create_table "tracks", force: :cascade do |t|
    ...
    t.index ["is_bonus"], name: "index_tracks_on_is_bonus"
